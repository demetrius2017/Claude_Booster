#!/usr/bin/env python3
"""Run GLM-5.3 via Z.ai's Anthropic-compatible Claude Code endpoint.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run GLM-5.3 through Z.ai.")
